...
function Dashboard() {
    ...
    console.log(companyData,"hhhhhhhhhhhhhhhhh")
        ...
        <div className='min-h-screen'>
            ...
            <div className='shadow py-4' >
                <div className='px-5 flex justify-between items-center'>
                    <img onClick={e => navigate('/')} className='max-sm:w-32 cursor-pointer' src={portalicon} width={80} alt="" />
                    {companyData && (
                    <div className='flex items-center gap-3'>
                      
                        <p className='max-sm:hidden'>Welcome {companyData.name}</p>
                        <div className='relative group'>
                            <img className='w-8 border rounded-full' src={companyData.image} width={100} alt="" />
